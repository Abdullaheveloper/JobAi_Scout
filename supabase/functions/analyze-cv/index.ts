...
- Extract a detailed summary that captures everything else: recent projects, achievements, education, certifications, languages, volunteer work, publications, awards, tools used, methodologies, and any other details. Write this summary in first person as if the candidate wrote it, using only facts from the CV.
            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  cvSummary: {
                    type: "string",
                    description: "Comprehensive first-person summary covering: recent projects with technologies used, education details, certifications, achievements, awards, publications, languages spoken, methodologies, and any other notable information from the CV. Only include facts from the CV."
                  }
                },
                required: ["fullName", "email", "phone", "location", "linkedinUrl", "githubUrl", "skills", "suggestedRoles", "experienceYears", "cvSummary"],
