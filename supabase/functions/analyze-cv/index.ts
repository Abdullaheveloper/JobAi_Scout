...
- Extract all certifications / credentials / awards / publications / licenses / achievements. Keep internship lines that appear under Certifications both in certifications AND as an experience entry with type "internship" (company + verification URL when present). Also populate credentials[] objects (title, issuer, date, verificationLink, type).
- Capture verification URLs (e.g. Kaizen Hive verify-certificate links) as credential verificationLink values.
