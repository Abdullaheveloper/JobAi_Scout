...
import {
  ...
  Shield, Mic, ClipboardList, Building2, StickyNote, Chrome, Headphones,
} from "lucide-react";
...
const userNav = [
  ...
  { title: "Job Form Fill", url: "/dashboard/extension", icon: Chrome },
...
function AppSidebar() {
  ...
  const homeUrl = role === "recruiter" ? "/recruiter/jobs" : role === "admin" ? "/admin" : "/dashboard";
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border">
      <SidebarContent className="flex flex-col">
        ...
        <SidebarGroup>
          <SidebarGroupLabel>
            {role === "recruiter" ? "Recruiter" : "Navigation"}
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {navItems.map((item) => (
