...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      /* order-last only in LTR: in RTL flex, first child already docks to inline-start (right).
         Applying order-last under dir=rtl would push the spacer to the physical left while
         the fixed panel stays on right-0 — broken mirror. */
      className="group peer hidden text-sidebar-foreground md:block ltr:data-[side=right]:order-last"
      data-state={state}
