...
export default function ResetPassword() {
  ...
  return <main className="min-h-screen bg-[#f6f6f2] text-[#1c1c1c]">
    <header className="border-b border-black/10 bg-white"><div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8"><Link to="/" aria-label="JobAI Scout home"><JobAILogo markClassName="h-9 w-9" /></Link><div className="flex items-center gap-2"><ThemeToggle /><LanguageSwitcher /></div></div></header>
